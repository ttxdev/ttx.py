...
class TestCreatorPartialDtoPaginationDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreatorPartialDtoPaginationDto:
        """Test CreatorPartialDtoPaginationDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatorPartialDtoPaginationDto`
        """
        model = CreatorPartialDtoPaginationDto()
        if include_optional:
    ...
    def testCreatorPartialDtoPaginationDto(self):
        """Test CreatorPartialDtoPaginationDto"""
