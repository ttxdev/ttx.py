...
class TestPlayerTransactionDto(unittest.TestCase):
    """PlayerTransactionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerTransactionDto:
        """Test PlayerTransactionDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerTransactionDto`
        """
        model = PlayerTransactionDto()
        if include_optional:
    ...
    def testPlayerTransactionDto(self):
        """Test PlayerTransactionDto"""
