...
class TestCreatorPartialDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreatorPartialDto:
        """Test CreatorPartialDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatorPartialDto`
        """
        model = CreatorPartialDto()
        if include_optional:
            return CreatorPartialDto(
                id = 56,
    ...
    def testCreatorPartialDto(self):
        """Test CreatorPartialDto"""
