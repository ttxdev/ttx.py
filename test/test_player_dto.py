...
class TestPlayerDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PlayerDto:
        """Test PlayerDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerDto`
        """
        model = PlayerDto()
        if include_optional:
            return PlayerDto(
                ...
                type = 'User',
                transactions = [
                    ttx.models.player_transaction_dto.PlayerTransactionDto(
                        id = 56, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        quantity = 56, 
                ...
                loot_boxes = [
                    ttx.models.loot_box_dto.LootBoxDto(
                        id = 56, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        is_open = True, 
                ...
                shares = [
                    ttx.models.player_share_dto.PlayerShareDto(
                        creator = ttx.models.creator_partial_dto.CreatorPartialDto(
                            id = 56, 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                history = [
                    ttx.models.portfolio_snapshot_dto.PortfolioSnapshotDto(
                        player_id = 56, 
                        value = 56, 
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
                    ]
