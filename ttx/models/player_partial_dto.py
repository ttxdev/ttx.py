...
class PlayerPartialDto(BaseModel):
    """
    PlayerPartialDto
    """ # noqa: E501
    id: StrictInt
    ...
    value: StrictInt
    type: PlayerType
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "name", "slug", "twitch_id", "url", "avatar_url", "credits", "portfolio", "value", "type"]
